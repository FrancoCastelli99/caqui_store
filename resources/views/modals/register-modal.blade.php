...
<style>
    ...
    .modal-body{background-image:url({{asset('img/background-register.jpg')}});
      ...
      <div class="modal-content">
          ...
          <div class="bs-example bs-example-tabs">
              <ul id="myTab" class="nav nav-tabs">
                <li id="tab1" class=" active tab-style login-shadow "><a href="#signin" data-toggle="tab">Entrar</a></li>
                <li id="tab2" class=" tab-style "><a href="#signup" data-toggle="tab">Registro</a></li>
          ...
          <div class="tab-pane fade active in" id="signin">
            <form class="form-horizontal">
              ...
              <div class="group">
                ...
                <span class="highlight"></span>
                <span class="bar"></span>
                <label class="label" for="date">Contraseña</label>
              </div>
  
              <div class="forgot-link">
                <a href="#forgot"  data-toggle="modal" data-target="#forgot-password"> Olvide mi contraseña</a>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <button id="signin" name="signin" class="btn btn-primary btn-block">Ingresar</button>
                </div>
              </div>
              </fieldset>
            </form>
